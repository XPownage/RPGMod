...
public class CustomBlockWorldGenMinable extends WorldGenerator {
	...
	public CustomBlockWorldGenMinable(IBlockState block, int veinSize, Block[] generateIn, Block[] generateNear,
	...
	public boolean generate(World worldIn, Random p_180709_2_, BlockPos p_180709_3_) {
		...
		double d0 = (double) ((float) (p_180709_3_.getX() + 8)
				+ MathHelper.sin(f) * (float) this.numberOfBlocks / 8.0F);
		double d1 = (double) ((float) (p_180709_3_.getX() + 8)
				- MathHelper.sin(f) * (float) this.numberOfBlocks / 8.0F);
		double d2 = (double) ((float) (p_180709_3_.getZ() + 8)
				+ MathHelper.cos(f) * (float) this.numberOfBlocks / 8.0F);
		double d3 = (double) ((float) (p_180709_3_.getZ() + 8)
				- MathHelper.cos(f) * (float) this.numberOfBlocks / 8.0F);
